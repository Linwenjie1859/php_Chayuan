                ...
                <div class="layui-card-body">
                    <table class="layui-hide" id="List" lay-filter="List">
                        ...
                        <script type="text/html" id="info">
                            ...
                            {{#  }else{ }}
                            <p>
                                {{# if(item.cart_info.productInfo.exchange_image!='' && d.type==3){ }}
                                <span><img style="width: 30px;height: 30px;margin:0;cursor: pointer;" src="{{item.cart_info.productInfo.exchange_image}}"></span>
                                {{# }else{ }}
