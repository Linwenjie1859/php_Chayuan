            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        {if condition="$orderInfo.real_name eq ''"}
                        <div class="col-xs-12">属于种植商品无收获地址信息</div>
                        {else/}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        {if condition="$orderInfo['type'] eq 3 "}
                        <div class="col-xs-6">消耗茶叶: {$orderInfo.used_tea_num?:0}片</div>
                        {else/}
