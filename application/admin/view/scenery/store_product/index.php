            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='type'}
                        {case value="1"}
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create_item')}',{h:700,w:1100})">添加茶树</button>
                        {/case}
                        {case value="2"}
...
//                    {field: 'status', title: '状态',templet:"#checkboxstatus"},
    ...
    //上架下架产品    Handsome Lin 错误：上下架url没有域名
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                ...
                if(data.is_del=="1") var code = {title:"操作提示",text:"确定恢复产品操作吗？",type:'info',confirm:'是的，恢复该产品'};
