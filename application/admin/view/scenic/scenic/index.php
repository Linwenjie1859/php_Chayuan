    ...
    <div class="col-sm-9 m-l-n-md">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create',array('cid'=>$where.cid))}',{w:1100,h:760})">添加景点</button>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <div class="input-group">
                                <input type="text" name="title" value="{$where.name}" placeholder="请输入关键词" class="input-sm form-control"> <span class="input-group-btn"><button type="submit" class="btn btn-sm btn-primary"> <i class="fa fa-search" ></i>搜索</button> </span>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="ibox-content">
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <th class="text-center" width="10%">分类名称</th>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td>[{$vo.catename}]{$vo.name}</td>
                        <td>{$vo.visit}</td>
                        <td>{$vo.telephone}</td>
                        <td>{$vo.add_time|date="Y-m-d H:i:s",###}</td>
                        <td class="text-center">'{:Url('edit')}?id=$vo['id']'
                            <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('edit')}?id=$vo['id']',{w:1100,h:760})"><i class="fa fa-paste"></i> 编辑</button>
