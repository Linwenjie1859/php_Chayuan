...
class CCPRestSDK {
	...
	private $Filename=RUNTIME_PATH; //日志文件
	private $Handle; 
	function __construct($ServerIP,$ServerPort,$SoftVersion)	
	{
        ...
        $this->Handle = fopen($this->Filename."log/sms_log.txt", 'a');
	}
    ...
    */
    public function setSubAccount($SubAccountSid,$SubAccountToken){
